...
const resources = {
    en: {
      ...
      label_reply_via: "Reply via",
            ...
            about_intro:
                "I'm Kelvin C Edouard, also known as kelvruntim. I do more than build applications; I transform complex technical needs into impactful global solutions across four languages and three cultures.",
            ...
            about_teaser_text: "Want to see how I can connect your business to the world? ",
            ...
            meta_title:
                "Kelvin C Edouard (kelvruntim) | Software Engineer Portfolio",
            meta_description:
                "Kelvin C Edouard (kelvruntim) is a Full-Stack Software Engineer building modern, scalable, and global digital solutions with React, Node.js, and AWS.",
            meta_keywords:
                "Kelvin C Edouard, kelvruntim, software engineer, full stack developer, React developer, Node.js, AWS, portfolio",
            og_title: "Kelvin C Edouard (kelvruntim) | Software Engineer",
            og_description:
                "Software Engineer focused on high-impact, global-ready web applications.",
            og_site_name: "Kelvin C Edouard Portfolio",
            twitter_title: "Kelvin C Edouard (kelvruntim) | Software Engineer",
            twitter_description:
            ...
            service_1_tags:
                "Customer Success|Support|Technical Help|Bilingual",
    ...
    pt: {
      ...
      label_reply_via: "Responder por",
            ...
            about_intro:
                "Sou Kelvin C Edouard, também conhecido como kelvruntim. Faço mais do que criar aplicações: transformo necessidades técnicas complexas em soluções globais impactantes em quatro idiomas e três culturas.",
            ...
            meta_title:
                "Kelvin C Edouard (kelvruntim) | Portfólio Engenheiro de Software",
            meta_description:
                "Kelvin C Edouard (kelvruntim) é engenheiro de software full-stack a criar soluções digitais modernas, escaláveis e globais com React, Node.js e AWS.",
            meta_keywords:
                "Kelvin C Edouard, kelvruntim, engenheiro de software, desenvolvedor full stack, React, Node.js, AWS, portfólio",
            og_title: "Kelvin C Edouard (kelvruntim) | Engenheiro de Software",
            og_description:
                "Engenheiro de software focado em aplicações web globais de alto impacto.",
            og_site_name: "Portfólio Kelvin C Edouard",
            twitter_title: "Kelvin C Edouard (kelvruntim) | Engenheiro de Software",
            twitter_description:
            ...
            service_1_tags:
                "Sucesso do cliente|Suporte|Ajuda técnica|Bilingue",
    ...
    es: {
      ...
      label_reply_via: "Responder por",
            ...
            about_intro:
                "Soy Kelvin C Edouard, también conocido como kelvruntim. Hago más que construir aplicaciones: transformo necesidades técnicas complejas en soluciones globales impactantes en cuatro idiomas y tres culturas.",
            ...
            edu_2_desc:
                "Completé el último año y profundicé en informática.",
            ...
            cert_1_provider: "Prof. Clarita",
            cert_1_info:
                "Primeros pasos en POO y sintaxis Java.",
            cert_2_title: "AWS Cloud Practitioner",
            cert_2_provider: "Amazon Web Services",
            ...
            meta_title:
                "Kelvin C Edouard (kelvruntim) | Portafolio Ingeniero de Software",
            meta_description:
                "Kelvin C Edouard (kelvruntim) es ingeniero de software full-stack que construye soluciones digitales modernas, escalables y globales con React, Node.js y AWS.",
            meta_keywords:
                "Kelvin C Edouard, kelvruntim, ingeniero de software, desarrollador full stack, React, Node.js, AWS, portafolio",
            og_title: "Kelvin C Edouard (kelvruntim) | Ingeniero de Software",
            og_description:
                "Ingeniero de software enfocado en aplicaciones web globales de alto impacto.",
            og_site_name: "Portafolio Kelvin C Edouard",
            twitter_title: "Kelvin C Edouard (kelvruntim) | Ingeniero de Software",
            twitter_description:
            ...
            service_1_tags:
                "Éxito del cliente|Soporte|Ayuda técnica|Bilingüe",
    ...
    ht: {
      ...
      label_reply_via: "Reponn pa",
            ...
            about_intro:
                "Mwen se Kelvin C Edouard, kelvruntim. Mwen fè plis pase bati aplikasyon; mwen transfòme bezwen teknik konplèks an solisyon global ki gen enpak nan kat lang ak twa kilti.",
            ...
            project_1_desc:
                "Solisyon e-komès ak React, Node.js, ak peman entegre.",
            ...
            project_4_desc:
                "Tablo analiz pou rezo sosyal ak vizyalizasyon ak rapò.",
            project_5_title: "Asistan chat IA",
            project_5_desc:
                "Asistan chat ak aprantisaj machin, NLP, ak kontèks.",
            ...
            cert_0_info:
                "Baz: algorit, C, ak estrikti done.",
            cert_1_title: "TodCODE: Entwodiksyon nan pwogramasyon",
            cert_1_provider: "Prof. Clarita",
            cert_1_info:
                "Premye pa nan OOP ak sintaks Java.",
            cert_2_title: "AWS Cloud Practitioner",
            cert_2_provider: "Amazon Web Services",
            ...
            meta_title:
                "Kelvin C Edouard (kelvruntim) | Pòtfolyo Enjenyè Lojisyèl",
            meta_description:
                "Kelvin C Edouard (kelvruntim) se yon enjenyè lojisyèl full-stack ki bati solisyon dijital modèn, ki ka grandi, ak global ak React, Node.js, ak AWS.",
            meta_keywords:
                "Kelvin C Edouard, kelvruntim, enjenyè lojisyèl, devlopè full stack, React, Node.js, AWS, pòtfolyo",
            og_title: "Kelvin C Edouard (kelvruntim) | Enjenyè Lojisyèl",
            og_description:
                "Enjenyè lojisyèl ki konsantre sou aplikasyon entènèt global ki gen enpak.",
            og_site_name: "Pòtfolyo Kelvin C Edouard",
            twitter_title: "Kelvin C Edouard (kelvruntim) | Enjenyè Lojisyèl",
            twitter_description:
                "Pwojè, konpetans, ak sèvis yon enjenyè full-stack.",
            ...
            service_1_tags:
                "Siksè kliyan|Sipò|Èd teknik|Biling",
